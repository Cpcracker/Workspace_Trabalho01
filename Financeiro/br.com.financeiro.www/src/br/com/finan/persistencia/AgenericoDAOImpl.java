...
public class AgenericoDAOImpl<T, ID extends Serializable> implements
	...
	public T incluir(T object) throws ExceptionUtil {
		try {
			...
			throw new ExceptionUtil(e, "Não foi possível realizar a inclusão.");
		}
		return object;
	}
	...
	public T alterar(T object) throws ExceptionUtil {
		try {
			...
			throw new ExceptionUtil(e, "Não foi possível realizar a alteração.");
		}
		return object;
	}
	...
	public T consultar(Integer id) throws ExceptionUtil {
		...
		try {
			...
			throw new ExceptionUtil(e, "Registro não encontrado.");
		} catch (Exception e) {
			throw new ExceptionUtil(e, "Não foi possível realizar a consulta.");
		}
		return object;
	}
	...
	public void excluir(Integer id) throws ExceptionUtil {
		try {
			...
			throw new ExceptionUtil(e, "Registro não encontrado para exclusão.");
		} catch (Exception e) {
			throw new ExceptionUtil(e, "Não foi possível realizar a exclusão.");
		}
	...
	public List<T> listar() throws ExceptionUtil {
		...
		try {
			...
			throw new ExceptionUtil(e, "Problemas na localização dos objetos");
		}
		return lista;
	}
